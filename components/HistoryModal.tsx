...
const HistoryModal: React.FC<HistoryModalProps> = ({ history, onClose }) => {
  return (
    <div className="absolute inset-0 z-[100] bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="bg-[#f0f0f0] border-4 border-black neo-shadow w-full max-w-[800px] h-full max-h-[80vh] flex flex-col">
        {/* Window Header */}
        <div className="bg-black text-white px-4 py-2 flex justify-between items-center border-b-4 border-black shrink-0">
        ...
        <div className="p-4 md:p-8 overflow-y-auto flex-1">
          <h2 className="text-3xl md:text-4xl font-black italic uppercase mb-6 border-b-4 border-black inline-block">Lịch Sử Chiến Đấu</h2>
